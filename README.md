...
## Areas of Improvement/Investigation

### Analyses
1. Analyse distribution of entry times of the day.
2. Performance of best model in the past month vs current month.
3. More analyses on options market activity.

### Implementation
1. Consider slippage and implementation of entry at multiple strikes.
2. Refine exit strategy.
3. Implement daily trading and higher frequency (e.g. 1 min) trading.
4. Parallelisation of trading step.
